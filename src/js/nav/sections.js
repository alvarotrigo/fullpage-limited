...
var g_hardCodedNavigationPosition = 'right';
...
export function addVerticalNavigation(){
    ...
    utils.addClass(nav, 'fp-' + g_hardCodedNavigationPosition);
    ...
    for (var i = 0; i < getState().sections.length; i++) {
        ...
        if (typeof tooltip !== 'undefined' && tooltip !== '') {
            li += '<div class="' + SECTION_NAV_TOOLTIP + ' fp-' + g_hardCodedNavigationPosition + '">' + tooltip + '</div>';
        }
