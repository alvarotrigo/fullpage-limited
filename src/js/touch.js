...
function touchMoveHandler(e){
    ...
    if (isReallyTouch(e) ) {
        ...
        var hardCodedTouchSensitivity = 5;
        var isVerticalMovementEnough = Math.abs(touchStartY - touchEndY) > (win.innerHeight / 100 * hardCodedTouchSensitivity);
        var isHorizontalMovementEnough = Math.abs(touchStartX - touchEndX) > (utils.getWindowWidth() / 100 * hardCodedTouchSensitivity);
